...
- [0008. Task Labels and Sprint Management](./0008-task-labels-and-sprint-management.md) - Structured labels with validation for multi-dimensional task organization - 2026-01-22
