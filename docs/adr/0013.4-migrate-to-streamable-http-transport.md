# 0013.4. Migrate to StreamableHTTPServerTransport - BLOCKED

> *Threaded under [0013](./0013-http-mcp-server-architecture.md); renumbered from 0023 on 2026-06-04. Content unchanged; history via `git mv`.*
...
ADR-0022 should be marked as "Superseded by ADR-0013.4" since this refactor replaces the temporary SSEServerTransport solution with the long-term StreamableHTTPServerTransport architecture.
